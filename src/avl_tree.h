...
template< typename T >
Avl_tree< T >::Avl_tree() : root( NULL )
{
} // end constructor Avl_tree

template< typename T >
Avl_tree< T >::~Avl_tree()
{
	clear_all();
} // end destructor Avl_tree

template< typename T >
bool Avl_tree< T >::is_empty_tree()
{
	return root == NULL;
} // end function is_empty_tree

template< typename T >
bool Avl_tree< T >::add( const T &item )
{
	bool is_insert;
...
template< typename T >
bool Avl_tree< T >::recursive_add( Node *new_node, Node *cur_node, Node *prev_node )
{
	bool is_insert;
...
template< typename T >
void Avl_tree< T >::search_replacement( Node *&cur_node, Node *&prev_node )
{
	Node *cur_node_2;
	Node *parent;
...
template< typename T >
bool Avl_tree< T >::recursive_del( Node *&cur_node, const T &item, Node *prev_node )
{
	bool is_remove;
	Node *parent;
	Node *cur_node_2;
...
template< typename T >
void Avl_tree< T >::inorder( const Node *cur_node )
{
	Node *tmp;
...
template< typename T >
void Avl_tree< T >::recursive_clear( Node *&cur_node )
{
	if( cur_node != NULL )
	{
...
template< typename T >
bool Avl_tree< T >::del( const T &item )
{
	bool is_delete;
...
template< typename T >
void Avl_tree< T >::all_rotation( Node *&cur_node )
{
	Node *b;
...
template< typename T >
void Avl_tree< T >::small_left_rotation( Node *&cur_node )
{
	Node *a = cur_node;
	Node *b = a->right;
	Node *L = a->left;
...
template< typename T >
void Avl_tree< T >::small_right_rotation( Node *&cur_node )
{
	Node *a = cur_node;
	Node *b = a->left;
	Node *L = b->left;
...
template< typename T >
void Avl_tree< T >::big_left_rotation( Node *&cur_node )
{
	Node *tmp_node_1;
	Node *tmp_node_2;
...
template< typename T >
void Avl_tree< T >::big_right_rotation( Node *&cur_node )
{
	Node *tmp_node_1 = new Node;
...
template < typename T >
bool Avl_tree< T >::find( const T &item )
{
	bool if_find;
...
template< typename T >
bool Avl_tree< T >::recursive_find( const Node *cur_node, const T &item )
{
	bool is_find;
